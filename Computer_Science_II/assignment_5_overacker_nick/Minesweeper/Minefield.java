...
public class Minefield implements Serializable
{
   ...
   {
      setMinefield(_width, _height, _numberOfMines);
   }


   /**
    * Sets the Minefield with the specified parameters.
    * @param _width The width (in cells) of the Minefield.
    * @param _height The height (in cells) of the Minefield.
    * @param _numberOfMines The maximum number of mines in the Minefield.
    */
   public void setMinefield(int _width, int _height, int _numberOfMines)
   {
